...
var JSONNestedNode = (_temp = _class = function (_React$Component) {
  ...
  function JSONNestedNode(props) {
    ...
    _this.handleClick = function () {
      var isExpanded = !_this.state.expanded;
      _this.setState({ expanded: isExpanded });
      _this.props.onToggle(isExpanded, _this.props.keyPath, _this.props.data, _this.props.level);
    };
